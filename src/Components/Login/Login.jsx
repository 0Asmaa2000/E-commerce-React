...
<Link className='text-blue-950 underline flex justify-end pt-2' to={`/forget?email=${encodeURIComponent(formik.values.email)}`}>Forget Password?</Link>
      ...
      <button type="submit" className="text-white bg-blue-800 hover:bg-blue-500  focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800 ">{isLoading?<i className='fas fa-spinner fa-spin'></i>:'Register'}</button>
